...
B3Spell_AlignCenter                   = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Centrer',                     1)
B3Spell_AutoPause                     = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Pause automatique',                       1)
B3Spell_AutoFocusSearchBar            = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Adapter automatiquement la barre de recherche',   1)
B3Spell_AutomaticallyOptimizeSlotSize = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Adapter automatiquement la taille des emplacements des sorts', 1)
B3Spell_DarkenBackground              = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Obscurcir le second plan',                0)
B3Spell_DisableControlBar             = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Désactiver la barre de contrôle',              0)
B3Spell_DisableSearchBar              = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Désactiver la barre de recherche',               0)
B3Spell_IgnoreSpecialAbilities        = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Ignorer les capacités spéciales',         0)
B3Spell_Modal                         = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Assombrir le second plan',                            1)
B3Spell_ShowKeyBindings               = Infinity_GetINIValue('Bubbs Spell Menu Extended', 'Afficher les raccourcis clavier',                0)

function B3Spell_SetAlignCenter(newVal)
	B3Spell_AlignCenter = newVal
	Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Centrer', B3Spell_AlignCenter)
end
...
B3Spell_Options = {
	{"Pause automatique : ",
		...
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Pause automatique', B3Spell_AutoPause) end,
	},
	{"Adapter automatiquement la barre de recherche : ",
		["set"] = function(newVal) B3Spell_AutoFocusSearchBar = newVal end,
		["get"] = function() return B3Spell_AutoFocusSearchBar end,
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Adapter automatiquement la barre de recherche', B3Spell_AutoFocusSearchBar) end,
	},
	{"Adapter automatiquement la taille des emplacements des sorts : ",
		...
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Adapter automatiquement la taille des emplacements des sorts', B3Spell_AutomaticallyOptimizeSlotSize) end,
	},
	{"Obscurcir le second plan : ",
		["set"] = function(newVal) B3Spell_DarkenBackground = newVal end,
		["get"] = function() return B3Spell_DarkenBackground end,
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Obscurcir le second plan', B3Spell_DarkenBackground) end
	},
	{"Désactiver la barre de contrôle : ",
		["set"] = function(newVal) B3Spell_DisableControlBar = newVal end,
		["get"] = function() return B3Spell_DisableControlBar end,
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Désactiver la barre de contrôle', B3Spell_DisableControlBar) end,
	...
	{"Désactiver la barre de recherche : ",
		...
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Désactiver la barre de recherche', B3Spell_DisableSearchBar) end,
		["onChange"] = function() B3Spell_Options_SlotsNeedReinit = true end,
	},
	{"Ignorer les capacités spéciales : ",
		...
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Ignorer les capacités spéciales', B3Spell_IgnoreSpecialAbilities) end,
	},
	{"Assombrir le second plan : ",
		["set"] = function(newVal) B3Spell_Modal = newVal end,
		["get"] = function() return B3Spell_Modal end,
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Assombrir le second plan', B3Spell_Modal) end,
	},
	{"Afficher les raccourcis clavier : ",
		["set"] = function(newVal) B3Spell_ShowKeyBindings = newVal end,
		["get"] = function() return B3Spell_ShowKeyBindings end,
		["write"] = function() Infinity_SetINIValue('Bubbs Spell Menu Extended', 'Afficher les raccourcis clavier', B3Spell_ShowKeyBindings) end,
		["onChange"] = function() B3Spell_Options_SlotsNeedReinit = true end,
	},
}
